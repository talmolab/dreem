...
from dreem.datasets import data_utils, BaseDatasetIterable
from torchvision.transforms import functional as tvf

logger = logging.getLogger("dreem.datasets")


class SleapIterableDataset(BaseDatasetIterable):
...
if __name__ == "__main__":
    ...
    label_files, vid_files = cfg.get_data_paths(dataset_params["train_dataset"])
    dataset_params = dataset_params["train_dataset"]
