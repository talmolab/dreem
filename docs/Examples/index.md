...
### [Quickstart: Fly Tracking](../quickstart.md)
**Best for:** First-time users  
**Runtime:** 5-10 minutes

A quick introduction to DREEM using a pretrained model on fly tracking data. Learn how to:
- Download sample data and models
- Run tracking with `dreem-track`
...
A complete walkthrough of the DREEM pipeline:
...
For more details on configuration options and advanced usage, see the [Usage Guide](../usage.md).
