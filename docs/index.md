...
- ✅ **Pretrained Models:** Get started quickly with models trained for [microscopy](https://huggingface.co/talmolab/dreem-microscopy-pretrained) and [animal](https://huggingface.co/talmolab/dreem-animals-pretrained) domains. Available on Hugging Face.
